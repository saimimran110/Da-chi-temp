...
import { ChevronLeft, ChevronRight, ShoppingCart, Droplet, Star, Bomb } from 'lucide-react'
...
import peechbottleMK from '../assets/peechbottleMK.png';
import real from '../assets/real.jpg';


const products = [
  { id: 1, name: 'Lavender Mist', image: Bombottle, price: 'Rs 250' },
  { id: 2, name: 'Citrus Breeze', image: pic2, price: 'Rs 300' },
  { id: 3, name: 'Ocean Fresh', image: Bossbottle, price: 'Rs 300' },
  { id: 4, name: 'Vanilla Silk', image: dvdbottle, price: 'Rs 420' },
  { id: 5, name: 'Bamboo Zen', image: peechbottle, price: 'Rs 270' },
  { id: 6, name: 'Rose Petal', image: peechbottleMK, price: 'Rs 340' },
  { id: 7, name: 'Midnight Musk', image: real, price: 'Rs 290' },
]

const bestSellers = [
  { id: 1, name: 'Lavender Mist', image: Bombottle, price: 'Rs 250', rating: 4.8 },
  { id: 2, name: 'Citrus Breeze', image: pic2, price: 'Rs 300', rating: 4.7 },
  { id: 3, name: 'Ocean Fresh', image: lemonbottle, price: '300', rating: 4.9 },
]
      ...
      <div className="relative z-10">
        <nav className="p-4 sticky top-0 bg-white z-50 flex items-center justify-between shadow-md">
          <div className="flex items-center">
            <img src={pic1} alt="Da-chi Logo" className="h-10 w-10 mr-4" />
